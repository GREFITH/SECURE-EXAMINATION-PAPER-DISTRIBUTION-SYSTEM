    ...
    if(isset($_POST['register']))
    {
        ...
        if(isset($image))
        {
          ...
          if(in_array($ext,$extension))
          {
            ...
            $insert="INSERT INTO `papers`(`img_name`) VALUES('$image')";
          ...
          {
            echo "<script>alert('please select right format')</script>";
          }
        }
        else
        {
                    ...
                    <div class="card-body">
                      ...
                      <form class="forms-sample" method="POST" action="" enctype="multipart/form-data">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="file" class="form-control" id="exampleInputUsername2" name="image" placeholder="image">
                          </div>
                        </div>
                        <button type="submit" class="btn btn-primary mr-2" name="register">Submit</button>
                        <!-- <button class="btn btn-dark"><a href="admission.php">Cancel</a></button> -->
                      </form>
                    </div>
                  </div>
                </div>
