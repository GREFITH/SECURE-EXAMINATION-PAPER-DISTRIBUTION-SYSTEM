<?php
              ...
              if(isset($_POST['submit']))
              {
                ...
                $department=$_POST['departnemt'];
                $education=$_POST['education'];
                $address=$_POST['address'];
                $insert="INSERT INTO `faculty`(`name`, `mobile`, `email`, `dob`, `gender`, `subject`,`department`, `qualification`, `address`) 
                VALUES ('$name','$mobile','$email','$dob','$gender','$subject','$department','$education','$address')";
                ...
                {
                  echo '<script> alert("Insert not succesful")</script>';
                  echo '<script> window.location="faculty.php"</script>';
                }
              }
?>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="" method="POST" class="forms-sample">
                    ...
                    <div class="form-group row">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label">Date of Birth</label>
                      <div class="col-sm-9">
                        <input type="date" name="dob" class="form-control" id="exampleInputMobile">
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        ...
                        <input style="margin-left:15px;" type="radio" value="male" name="gender"><label style="margin-left:5px;font-size:20px">Male</label>
                        <input style="margin-left:15px;" type="radio" value="female" name="gender"><label style="margin-left:5px;font-size:20px">Female</label>
                        <input style="margin-left:15px;" type="radio" value="others" name="gender"><label style="margin-left:5px;font-size:20px">Others</label>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="department" class="form-control" id="exampleInputEmail2">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Education Qualification</label>
                      <div class="col-sm-9">
                        <input type="text" name="education" class="form-control" id="exampleInputEmail2">
                      </div>
                    </div>
